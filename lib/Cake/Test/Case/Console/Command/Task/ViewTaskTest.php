 ...
 */
	public function testBakeView() {
		...
		$this->Task->expects($this->at(0))->method('createFile')
			->with(
				TMP . 'ViewTaskComments' . DS . 'view_staff.ctp',
 ...
 */
	public function testBakeEdit() {
		...
		$this->Task->expects($this->at(0))->method('createFile')
			->with(
				TMP . 'ViewTaskComments' . DS . 'edit_staff.ctp',
 ...
 */
	public function testBakeIndex() {
		...
		$expected = file_get_contents(CAKE . 'Test' . DS . 'bake_compare' . DS . 'View' . DS . 'list_staff.ctp');
		$this->Task->expects($this->at(0))->method('createFile')
			->with(
				TMP . 'ViewTaskComments' . DS . 'list_staff.ctp',
				$expected
			);
 ...
 */
	public function testBakeWithPlugin() {
		...
		$path = APP . 'Plugin' . DS . 'TestTest' . DS . 'View' . DS . 'ViewTaskComments' . DS . 'view_staff.ctp';
 ...
 */
	public function testExecuteIntoAll() {
		...
		$this->Task->expects($this->at(1))->method('createFile')
			->with(
				TMP . 'ViewTaskComments' . DS . 'add_staff.ctp',
				$this->anything()
			);
