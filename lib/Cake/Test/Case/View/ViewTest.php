 ...
 */
	public function testGetTemplate() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Themed' . DS . 'TestTheme' . DS . 'Posts' . DS . 'list_staff.ctp';
 ...
 */
	public function testPluginGetTemplateAbsoluteFail() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS . 'Company' . DS . 'TestPluginThree' . DS . 'View' . DS . 'Pages' . DS . 'list_staff.ctp';
 ...
 */
	public function testPluginGetTemplate() {
		...
		$expected = CakePlugin::path('TestPlugin') . 'View' . DS . 'Tests' . DS . 'list_staff.ctp';
 ...
 */
	public function testPluginThemedGetTemplate() {
		...
		$ThemeView = new TestThemeView($this->Controller);
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Themed' . DS . 'TestTheme' . DS . 'Plugin' . DS . 'TestPlugin' . DS . 'Tests' . DS . 'list_staff.ctp';
 ...
 */
	public function testCamelCasePluginGetTemplate() {
		...
		$pluginPath = CakePlugin::path('TestPlugin');
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS . 'TestPlugin' . DS . 'View' . DS . 'Tests' . DS . 'list_staff.ctp';
		$result = $View->getViewFileName('index');
		$this->assertEquals($expected, $result);
 ...
 */
	public function testGetViewFileNames() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Posts' . DS . 'list_staff.ctp';
 ...
 */
	public function testViewFileName() {
		...
		$result = $View->getViewFileName('index');
		$this->assertRegExp('/Posts(\/|\\\)list_staff.ctp/', $result);
		...
		$this->assertRegExp('/Themed(\/|\\\)TestTheme(\/|\\\)Posts(\/|\\\)list_staff.ctp/', $result);
