 ...
 */
	public function testGetViewFilename() {
		...
		$expected = CAKE . 'View' . DS . 'Scaffolds' . DS . 'list_staff.ctp';
		...
		$expected = CAKE . 'View' . DS . 'Scaffolds' . DS . 'view_staff.ctp';
		$this->assertEquals($expected, $result);
 ...
 */
	public function testGetViewFileNameWithTheme() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS .
			'Themed' . DS . 'TestTheme' . DS . 'Posts' . DS . 'scaffold.list_staff.ctp';
		$this->assertEquals($expected, $result);
	}
